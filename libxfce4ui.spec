...
Version  : 4.13.7
Release  : 27
URL      : http://archive.xfce.org/src/xfce/libxfce4ui/4.13/libxfce4ui-4.13.7.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/libxfce4ui/4.13/libxfce4ui-4.13.7.tar.bz2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564972138
