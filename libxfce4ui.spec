...
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.16/libxfce4ui-4.16.0.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.16.0
cd %{_builddir}/libxfce4ui-4.16.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609285843
...
cp %{_builddir}/libxfce4ui-4.16.0/COPYING %{buildroot}/usr/share/package-licenses/libxfce4ui/83ba6546e00f890f3a26a9bedd264084f8527d5e
%make_install
