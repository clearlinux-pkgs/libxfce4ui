...
Version  : 4.15.1
Release  : 29
URL      : http://archive.xfce.org/src/xfce/libxfce4ui/4.15/libxfce4ui-4.15.1.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/libxfce4ui/4.15/libxfce4ui-4.15.1.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.15.1
cd %{_builddir}/libxfce4ui-4.15.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579910709
...
cp %{_builddir}/libxfce4ui-4.15.1/COPYING %{buildroot}/usr/share/package-licenses/libxfce4ui/83ba6546e00f890f3a26a9bedd264084f8527d5e
%make_install
