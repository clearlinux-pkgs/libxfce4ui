...
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.18/libxfce4ui-4.18.6.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.18.6
cd %{_builddir}/libxfce4ui-4.18.6
%patch -P 1 -p1
pushd ..
cp -a libxfce4ui-4.18.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709912100
