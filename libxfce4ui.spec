...
Version  : 4.20.1
Release  : 41
URL      : https://archive.xfce.org/src/xfce/libxfce4ui/4.20/libxfce4ui-4.20.1.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.20/libxfce4ui-4.20.1.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.20.1
cd %{_builddir}/libxfce4ui-4.20.1
%patch -P 1 -p1
pushd ..
cp -a libxfce4ui-4.20.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742762063
...
/usr/share/gtk-doc/html/libxfce4ui/ch01.html
...
/usr/share/gtk-doc/html/libxfce4ui/object-tree.html
