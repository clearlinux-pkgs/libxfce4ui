...
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.18/libxfce4ui-4.18.0.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.18.0
cd %{_builddir}/libxfce4ui-4.18.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671135103
