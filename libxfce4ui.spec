...
Version  : 4.18.5
Release  : 38
URL      : https://archive.xfce.org/src/xfce/libxfce4ui/4.18/libxfce4ui-4.18.5.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.18/libxfce4ui-4.18.5.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.18.5
cd %{_builddir}/libxfce4ui-4.18.5
%patch -P 1 -p1
pushd ..
cp -a libxfce4ui-4.18.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707232980
