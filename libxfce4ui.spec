...
Source0  : https://archive.xfce.org/src/xfce/libxfce4ui/4.16/libxfce4ui-4.16.1.tar.bz2
...
%prep
%setup -q -n libxfce4ui-4.16.1
cd %{_builddir}/libxfce4ui-4.16.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630885785
...
cp %{_builddir}/libxfce4ui-4.16.1/COPYING %{buildroot}/usr/share/package-licenses/libxfce4ui/83ba6546e00f890f3a26a9bedd264084f8527d5e
%make_install
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libxfce4ui/83ba6546e00f890f3a26a9bedd264084f8527d5e
